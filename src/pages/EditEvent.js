...
import { connect } from "react-redux";
import { editEvent, createEvent, resetNewImage } from "../reducers/event_reducer";
...
handleSubmit = data => {
  ...
  render() {
    return (
      <div>
        <CreateEventWizardForm handleSubmit={this.handleSubmit} populatedValue={this.state.event} />
      </div>
    );
  }
}

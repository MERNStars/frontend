...
context("users component", () => {
  it("creates a new account", () => {
    ...
    cy.get("form > :nth-child(1)").type(
      `test${Math.floor(Math.random() * 9999)}@test.com`
    );
    ...
    cy.get("#rw_1_input > .rw-widget-input > .rw-input")
      .click()
      .type("{downarrow}")
      .wait(1000);
    cy.get("#rw_2_input > .rw-widget-input > .rw-input")
      .click()
      .type("{downarrow}")
      .wait(1000);
    cy.get(":nth-child(9) > .form_Categories__2HsTY > .rw-widget-input > div")
      .click()
      .type("{downarrow}")
      .wait(1000)
      .type("{enter}")
